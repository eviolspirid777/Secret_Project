...
namespace Secret_Project_Backend.Migrations
{
    ...
    [Migration("20250824171316_MIGRATION_add_replied_channel_messages")]
    partial class MIGRATION_add_replied_channel_messages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Secret_Project_Backend.Models.Channel", b =>
                {
                    ...
                    b.HasOne("Secret_Project_Backend.Models.Room", "Room")
                        .WithOne("Channel")
                        .HasForeignKey("Secret_Project_Backend.Models.Channel", "RoomId")
            ...
            modelBuilder.Entity("Secret_Project_Backend.Models.Message", b =>
                {
                    ...
                    b.HasOne("Secret_Project_Backend.Models.Message", "RepliedMessage")
                        .WithMany()
                        .HasForeignKey("RepliedId")
                        .OnDelete(DeleteBehavior.SetNull);
